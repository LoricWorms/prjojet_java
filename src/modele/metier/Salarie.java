...
public class Salarie {
    ...
    /** 
     * Constructeur du salarié avec son service et sa categorie
     * @param code  matricule du salarié
     * @param nom   
     * @param prenom
     * @param dateNaiss    date de naissance du salarié
    ...
    public Salarie(String code, String nom, String prenom, Date dateNaiss, Date dateEmbauche, String fonction, double tauxHoraire, String situationFamiliale, int nbrEnfants, Service serv, Categorie cate) {
